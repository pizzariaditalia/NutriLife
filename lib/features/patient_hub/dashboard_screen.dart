              ...
              children: [
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Último registro: $pesoTexto', 
                                style: const TextStyle(fontSize: 13, color: AppColors.primarySage, fontWeight: FontWeight.bold)
                              )
                            ]
                          ),
                          ElevatedButton.icon(
                ...
                GestureDetector(
                  onTap: () => Navigator.push(
                    context, 
                    MaterialPageRoute(builder: (context) => const EvolutionGalleryScreen())
                  ),
                  child: Container(
                    padding: const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: const [
                              ...
                              Text(
                                'Visualize seu Antes e Depois visual', 
  ...
  Widget _construirCardTool(IconData icone, String titulo, String sub, Color cor, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start, // Esta foi a linha corrigida
          children: [
