...
// 🚀 RESTAURADO: Tela de Conquistas de volta ao menu inferior
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  final List<Widget> _telas = [
    ...
    const AchievementsScreen(), // 🚀 RESTAURADO
  ];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.emoji_events_outlined), activeIcon: Icon(Icons.emoji_events), label: 'Conquistas'), // 🚀 RESTAURADO
        ],
      ),
    );
  }
